            ...
            item {
                ...
                Card(
                    ...
                    var themeMode by rememberSaveable {
                        mutableIntStateOf(prefs.getInt("color_mode", 0).coerceIn(0, 5))
                    }
                    SuperDropdown(
                    ...
                    var uiModeIndex by rememberSaveable {
                        mutableIntStateOf(
                            if (prefs.getString("ui_mode", UiMode.DEFAULT_VALUE) == UiMode.Material.value) 1 else 0
                        )
                    }
                    SuperDropdown(
                        ...
                        onSelectedIndexChange = { index ->
                            prefs.edit { putString("ui_mode", if (index == 0) UiMode.Miuix.value else UiMode.Material.value) }
                            uiModeIndex = index
                        }
                    )
